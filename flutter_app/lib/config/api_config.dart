...
class ApiConfig {
  ...
  static const String prodApiUrl = 'https://devtrack-pwkj.onrender.com/api';
  ...
  static const String githubClientId = 'Ov23liNjaTQGQWa3SCMJ';  // From Clerk integration
  static const String githubRedirectUri = 'devtrack://oauth/callback';
  
  // Clerk Configuration (for web auth reference)
  static const String clerkPublishableKey = 'pk_test_aGlwLXNlYWwtODQuY2xlcmsuYWNjb3VudHMuZGV2JA';
  
  /// Get the appropriate API URL based on environment
  static String get baseUrl {
    // TODO: Use environment detection
    const bool isProduction = false;
    return isProduction ? prodApiUrl : apiUrl;
  }
}
...
class ApiEndpoints {
  ...
  static String githubRepo(String owner, String repo) => '/github/repos/$owner/$repo';
